...
class Goodslist extends Component{
    ...
    // 初始化
    init(page) {
        $.get('http://localhost:2323/goodslist', {goodsid: 'mocha', page: page || 1}, res => {
            this.state.pageNum = []
    ...
    show(val, obj){
        if (val === 1) {
            ...
            $('.modifi-goodslist-box input')[3].value = obj.chinatitle;
    ...
    modifi() {
        var obj = {
            ...
            chinatitle: $('.modifi-goodslist-box input')[3].value,
    ...
    // 查询按钮
    queryBtn() {
        $.get('http://localhost:2323/goodslist', {goodsid: 'mocha', name: $('.goodsName').val()}, res => { 
            if (res.code === 1) {
                this.setState({
                    data: res.data
                })
    ...
    add(){
        var obj = {
            ...
            chinatitle: $('.add-goodslist-box input')[3].value,
