...
class Bread extends Component{
    ...
    init(page){
        $.get('http://localhost:2323/goodslist', {goodsid: 'bread', page: page || 1}, res => { 
            this.state.pageNum = []
    ...
    show(val, obj){
        if (val === 1) {
            ...
            $('.modifi-goodslist-box input')[6].value = obj.size;
            $('.modifi-goodslist-box input')[7].value = obj.number;
            $('.modifi-goodslist-box input')[8].value = obj.price;
            $('.modifi-goodslist-box input')[9].value = obj.imgArry;
            $('.modifi-goodslist-box input')[10].value = obj.deimg;
    ...
    modifi() {
        var obj = {
            ...
            size: $('.modifi-goodslist-box input')[6].value,
            number: $('.modifi-goodslist-box input')[7].value,
            price: $('.modifi-goodslist-box input')[8].value,
            imgArry: $('.modifi-goodslist-box input')[9].value,
            deimg: $('.modifi-goodslist-box input')[10].value,
            _id: this.state._id
        }
    ...
    add(){
        var obj = {
            ...
            size: $('.add-goodslist-box input')[6].value,
            number: $('.add-goodslist-box input')[7].value,
            price: $('.add-goodslist-box input')[8].value,
            imgArry: $('.add-goodslist-box input')[9].value.split(','),
            deimg: $('.add-goodslist-box input')[10].value,
        }
    ...
    queryBtn(){
        $.get('http://localhost:2323/goodslist', {goodsid: 'bread',name:$('.goodsName').val()}, res => { 
            if(res.code === 1){
                this.setState({
                    data: res.data
                })
            ...
            <div className="bread">
                ...
                <div className="add-dialog">
                    <ul className="add-goodslist-box">
                        ...
                        <li><div>类型:</div><input type="text" defaultValue="bread"/></li>
