...
class Temperature extends Component{
    ...
    init(page){
        $.get('http://localhost:2323/goodslist', {goodsid: 'temperature', page: page || 1}, res => { 
            this.state.pageNum = []
    ...
    add(){
        var obj = {
            ...
            imgAry: $('.add-goodslist-box input')[11].value.split(','),
    ...
    // 查询按钮
    queryBtn() {
        $.get('http://localhost:2323/goodslist', {goodsid: 'temperature', name: $('.goodsName').val()}, res => { 
            if (res.code === 1) {
                this.setState({
                    data: res.data
                })
    ...
    render(){
        return (
            <div className="temperature">
                ...
                <p className="headline">常温蛋糕商品列表</p>  
                <table>
                    <thead>
                        <tr>
                            <th>商品名字</th>
